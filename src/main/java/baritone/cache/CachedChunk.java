...
// This should really not need to happen
            ...
            // Overworld ores — must be tracked so the region cache remembers ore positions
            // in chunks that have since unloaded; without this the bot only sees ores inside
            // the current render distance (the same limitation the user noticed vs. x-ray).
            Blocks.COAL_ORE,
